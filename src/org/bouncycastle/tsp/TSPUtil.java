...
import javaf.util.ArrayList;
import javaf.util.Collection;
import javaf.util.Collections;
import javaf.util.HashMap;
import javaf.util.List;
...
public class TSPUtil
{
    ...
    static List getExtensionOIDs(Extensions extensions)
    {
        ...
        return Collections.unmodifiableList(javaf.util.Arrays.asList(extensions.getExtensionOIDs()));
    }
